...
node {
    ...
    stage('Anchore analyse') {
        writeFile file: 'anchore_images', text: 'strobodov/flask-alpine:2603d45'
    ...
    */
    ...
    stage ('Deploy') {
        ...
        sh "sed 's#127.0.0.1:30400/flask-alpine:version#strobodov/flask-alpine:'$BUILD_TAG'#' deployment.yaml | kubectl apply -n default -f -"
